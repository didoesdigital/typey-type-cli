...
- The vendor data, `vendor/emoji_strategy_c8900a0.json`, from [emojione](https://github.com/joypixels/emojione) is licensed under MIT License, as shown in [LICENSE_3RD_PARTY.md](./LICENSE_3RD_PARTY.md).
